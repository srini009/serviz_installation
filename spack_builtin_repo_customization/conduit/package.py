...
class Conduit(CMakePackage):
    ...
    version('develop', branch='develop', submodules=True, commit='8edd1c6118bb6f798ea569a57b5cda2ae2ada600')
    ...
    version('master', branch='develop', submodules=True, commit='8edd1c6118bb6f798ea569a57b5cda2ae2ada600')
