...
class VtkH(Package, CudaPackage):
    ...
    version('0.8.0', branch='develop', commit="be86a73f6dc53176e076002f9520bc37b16b5119", submodules=True)
...
#    depends_on("vtk-m@:1.6~tbb~openmp", when="~openmp")
    ...
    depends_on("vtk-m@1.7.0~tbb+openmp", when="@0.8.0+openmp")
    depends_on("vtk-m@1.7.0~tbb~openmp", when="@0.8.0~openmp")
...
#    depends_on("vtk-m@:1.6~tbb~openmp~shared", when="~openmp~shared")
    ...
    depends_on("vtk-m@1.7.0~tbb+openmp~shared", when="+openmp~shared")
    depends_on("vtk-m@1.7.0~tbb~openmp~shared", when="~openmp~shared")
